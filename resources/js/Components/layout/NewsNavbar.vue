...
import { Search, TextAlignEnd, X } from 'lucide-vue-next';
...
<template>
    <header class="bg-white border-b border-gray-200 py-3 sticky top-0 z-50 shadow-sm">
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8">
            <Link href="/" class="flex items-center md:border-l-4 border-red-700 md:pl-3 hover:opacity-90 transition-opacity">
                <span
                    class="text-xl bg-red-700 rounded text-gray-50 font-bold px-1.5 py-0.5 tracking-tight">VIRAL</span>
                <span class="text-2xl font-extrabold tracking-tighter text-red-700 ml-0.5">86</span>
            </Link>
            ...
            <div class="hidden md:block">
                <div class="relative">
                    <input type="text" placeholder="Cari berita..."
                        class="pl-4 pr-10 py-1.5 border-l-2 border-gray-300 bg-gray-50 focus:bg-white focus:border-red-700 focus:ring-0 text-sm transition-all outline-none w-40 lg:w-56" />
    ...
    <aside :class="isSidebarOpen ? 'translate-x-0' : 'translate-x-full'"
        ...
        <div class="p-6 flex flex-col h-full">
            ...
            <div class="mt-auto pb-6">
                <p class="text-xs text-gray-400 font-medium tracking-widest uppercase">VIRAL86 News Portal</p>
            </div>
        </div>
    </aside>
</template>
